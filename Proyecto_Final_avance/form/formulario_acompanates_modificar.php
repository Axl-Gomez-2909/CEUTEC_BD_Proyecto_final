      ...
      <nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="formulario_acompanates_modificar.php">Formulario/Modificar</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Actualización Acompañantes</h2>
                            <ol class="breadcrumb">
                    ...
                    <br>
                    <form action="../action/procesar_acompanates_modificar.php" method="post" >
                    <div class="form-group">
                            <label for="codigo">Codigo:</label>
                            <input type="number" class="form-control" id="codigo" name="codigo" step="0.01" autofocus required>
                        </div>
                        <div class="form-group">
