    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li ><a href="formulario_proveedores_ingresar.php">Formulario/Ingresar</a></li>
                            <li class="active"><a href="formulario_proveedores_modificar.php">Formulario/Modificar</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Actualización Proveedores</h2>
                            <ol class="breadcrumb">
                    ...
                    <br>
                    <form action="../action/proveedores_db_modificar.php" method="post">              
                             <div class="form-group">
                                <label for="codigo">Código del Proveedor:</label>
                                <input type="number" class="form-control" id="codigo" name="codigo" autofocus require>
                            </div> 
                            <div class="form-group">
