    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="formulario_proacomp_ingresar.php">Formulario/Ingresar</a></li>
                            <li ><a href="formulario_proacomp_modificar.php">Formulario/Modificar</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Ingreso Producto Acompañantes</h2>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="../index.php">Inicio</a>
                                </li>
                                <li class="breadcrumb-item active">
                                    <strong>Productos_Acompañantes</strong>
                                </li>
                            </ol>
                        </div>
                    ...
                    <br>
                    <form action="../action/procesar_proacomp_ingresar.php" method="post" >
                        <div class="form-group">
                            <label for="productoId">Codigo del Producto:</label>
                            <input type="number" class="form-control" id="productoId" name="productoId" autofocus required>
                        </div>
                        <div class="form-group">
                            <label for="acompananteId">Codigo del Acompanante:</label>
                            <input type="number" class="form-control" id="acompananteId" name="acompananteId" required>
                        </div>
                        <div class="form-group">
