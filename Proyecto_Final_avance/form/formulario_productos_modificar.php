                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li ><a href="formulario_productos_ingresar.php">Formulario/Ingresar</a></li>
                            <li class="active"><a href="formulario_productos_modificar.php">Formulario/Modificar</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    ...
                    <br>
                    <form action="../action/productos_db_editar.php" method="post"> 
                    <div class="form-group">
                            <label for="ID">Codigo del Producto:</label>
                            <input type="number" class="form-control" id="ID" name="ID" autofocus required>
                        </div>      
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="UbicacionBodega">Ubicacion de la Bodega:</label>
