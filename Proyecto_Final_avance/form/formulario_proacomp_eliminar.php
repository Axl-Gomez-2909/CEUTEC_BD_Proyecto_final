    ...
    <div id="wrapper">
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="formulario_proacomp_eliminar.php">Formulario/Eliminar</a></li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Eliminación Producto Acompañantes</h2>
                            <ol class="breadcrumb">
                    ...
                    <br>
                    <form action="../action/procesar_proacomp_eliminar.php" method="post" >
