    ...
    <div id="wrapper">
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="formulario_platoscomp_modificar.php">Formulario/Modificar</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Modificación Platos Acompañantes</h2>
                            <ol class="breadcrumb">
                    ...
                    <br>
                    <form action="../action/platos_acomp_actualizar.php" method="post">
