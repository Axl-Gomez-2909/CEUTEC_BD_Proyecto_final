    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Modificar Producto Acompañantes</h2>
                            <ol class="breadcrumb">
                    ...
                    <h3>Formulario de modifición de datos.</h3>
                   
                    <br>
                    <form action="../action/procesar_proacomp_modificar.php" method="post" >
                    <div class="form-group">
                            <label for="codigo">Codigo:</label>
                            <input type="number" class="form-control" id="codigo" name="codigo" autofocus required>
                        </div>
                        <div class="form-group">
