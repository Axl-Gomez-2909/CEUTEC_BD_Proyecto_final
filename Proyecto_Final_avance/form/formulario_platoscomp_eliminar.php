    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li ><a href="formulario_platoscomp_ingresar.php">Formulario/Ingresar</a></li>
                            <li ><a href="formulario_platoscomp_modificar.php">Formulario/Modificar</a></li>
                            <li class="active"><a href="formulario_platoscomp_eliminar.php">Formulario/Eliminar</a></li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Eliminación Platos Acompañantes</h2>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="../index.php">Inicio</a>
                                </li>
                                <li class="breadcrumb-item active">
                                    <strong>Platos_Acompañantes</strong>
                                </li>
                            </ol>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <br>
                    <form action="../action/platos_acomp_eliminar.php" method="post">
                        ...
                        <button type="submit" class="btn btn-primary">Eliminar Acompañante</button>
                   </form>
