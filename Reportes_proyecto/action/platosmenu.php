...
try {
    ...
    from  platos 
WHERE ID IN(
    select platoID from platosmenudiario where  MenuDiarioID IN(
        select ID from menudiario where fechaElaboracion = '2023-10-10')
        )";
...
<div id="wrapper">
    <nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="platosmenu.php">Platos/Menú</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <h4 class="mb-4">Listar todos los platos que pertenecen al menú de una fecha en específico.</h4>
