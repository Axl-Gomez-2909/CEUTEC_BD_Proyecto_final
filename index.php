            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li >
                        ...
                        <ul class="nav nav-second-level">
                            <li ><a href="formularios_action/formulario_acompanates_ingresar.php">Formulario/Ingresar</a></li>
                            <li ><a href="formularios_action/formulario_acompanates_modificar.php">Formulario/Modificar</a></li>
                            <li class="active"><a href="formularios_action/formulario_acompanates_eliminar.php">Formulario/Eliminar</a></li>
                        </ul>
                    </li>
                    <li >
                        <a href="index.php"><i class="fa fa-spinner"></i> <span class="nav-label">Productos/Acomp</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li ><a href="formularios_action/formulario_proacomp_ingresar.php">Formulario/Ingresar</a></li>
                            <li class="active"><a href="formularios_action/formulario_proacomp_modificar.php">Formulario/Modificar</a></li>
